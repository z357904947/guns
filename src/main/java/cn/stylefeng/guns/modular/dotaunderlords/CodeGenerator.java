package cn.stylefeng.guns.modular.dotaunderlords;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D://xiangm/guns/src/main/java/");
        ...
        pc.setParent("cn.stylefeng.guns.modular.dotaunderlords");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名
                return "D://xiangm/guns/src/main/resources/mapper/" //  + pc.getModuleName() 注释掉mapper.后要输入的
